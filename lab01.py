def main():
    ...
    # PART 1
    subtotal_cost = cost_per_item * quantity # subtotal before tax
    tax = subtotal_cost * 0.13 # 13% tax
    total_cost = subtotal_cost + tax # total cost after tax
    ...
    # PART 3
    # runtime error: investment is a float, cannot print the value as the print doesnt work
    # 
